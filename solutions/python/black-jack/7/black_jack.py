...
def value_of_ace(card_one, card_two):
    ...
    if value_card_one + value_card_two > 10 or 'A' in hand:
        return 1
    return 11
...
def is_blackjack(card_one, card_two):
    ...
    return ('A' in hand and '10' in hand) or ('A' in hand and 'K' in hand) or ('A' in hand and 'Q' in hand) or ('A' in hand and 'J' in hand)
...
def can_double_down(card_one, card_two):
    ...
    return (value_card_one + value_card_two == 9) or (value_card_one + value_card_two == 10) or (value_card_one + value_card_two == 11)